...
base_url = "http://news.naver.com/main/ranking/popularWeek.nhn?mid=etc&rankingType=popular_week&sectionId=100&date="  
url_list = list()
...
write.csv(ranking_news, file = "naver_weeklyClick_2016.csv")
